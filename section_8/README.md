...
To get started on manual refine, follow this [guide][anvi-meren-refine-bins-link]. There is also very insightful information from this [guide][anvi-veronica-refine-bins-link]. **Be sure to read through and follow along both**.
